<x-app-layout>
  <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800">All Orders</h2></x-slot>
      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="divide-y">
          ...
          <tr>
            ...
            <td class="px-4 py-3">{{ $o->user->name }} ({{ $o->user->email }})</td>
            ...
            <td class="px-4 py-3"><a href="{{ route('admin.orders.show',$o) }}" class="text-lblue">View</a></td>
          </tr>
          @endforeach
        </tbody>
      </table>
